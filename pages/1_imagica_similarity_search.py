...
# Set page config
st.set_page_config(page_title="Imagica Projects search with vector db", page_icon="📈", layout="wide")

st.markdown("# Imagica Projects")
st.sidebar.header("Imagica Projects")
